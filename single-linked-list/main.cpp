...
void Test1() {
    ...
    struct ThrowOnCopy {
        ...
        // Адрес сч тчика обратного отсч та. Если не равен nullptr, то уменьшается при каждом копировании.
...

    {
        ...
        // Последовательно уменьшаем сч тчик копирований до нуля, пока не будет выброшено исключение
...
void Test3() {
    ...
    // Обмен содержимого списков
    {
        ...
        // Обмен при помощи функции swap
        {
			...
			// то итератор first.begin() не будет равен ранее сохран нному значению,
    ...
    // Безопасное присваивание списков
    {
        ...
        try {
        	...
        	// Проверяем, что состояние списка-при мника не изменилось
